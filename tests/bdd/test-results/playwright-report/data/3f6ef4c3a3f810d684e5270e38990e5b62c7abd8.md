...
- Name: Feature: Automatic URL Generation >> Scenario: Generate a URL for a list with special characters in name
- Location: C:\projects\tests\bdd\cucumber-playwright-adapter.spec.jsx:101:11

# Error details

```
Error: Command failed: npx cross-env TEST_TYPE=bdd cucumber-js "C:\projects\tests\bdd\features\automatic-url-generation.feature" --require="C:\projects\tests\bdd\cucumber-setup.cjs" --require=C:\projects\tests\bdd\steps/**/*.{jsx,cjs} --require=C:\projects\tests\bdd\support/**/*.{jsx,cjs} --require=C:\projects\tests\bdd\pages/**/*.jsx --name "Generate a URL for a list with special characters in name"
