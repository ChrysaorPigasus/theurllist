...
- Name: Feature: Viewing all lists >> Scenario: Filter lists by published status
- Location: C:\projects\tests\bdd\cucumber-playwright-adapter.spec.jsx:101:11

# Error details

```
Error: Command failed: npx cross-env TEST_TYPE=bdd cucumber-js "C:\projects\tests\bdd\features\view-all-lists.feature" --require="C:\projects\tests\bdd\cucumber-setup.cjs" --require=C:\projects\tests\bdd\steps/**/*.{jsx,cjs} --require=C:\projects\tests\bdd\support/**/*.{jsx,cjs} --require=C:\projects\tests\bdd\pages/**/*.jsx --name "Filter lists by published status"
