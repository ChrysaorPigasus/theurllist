...
- Name: Feature: Error Handling and Edge Cases >> Scenario: Recover from network error when adding URLs
- Location: C:\projects\tests\bdd\cucumber-playwright-adapter.spec.jsx:101:11

# Error details

```
Error: Command failed: npx cross-env TEST_TYPE=bdd cucumber-js "C:\projects\tests\bdd\features\error-handling-and-edge-cases.feature" --require="C:\projects\tests\bdd\cucumber-setup.cjs" --require=C:\projects\tests\bdd\steps/**/*.{jsx,cjs} --require=C:\projects\tests\bdd\support/**/*.{jsx,cjs} --require=C:\projects\tests\bdd\pages/**/*.jsx --name "Recover from network error when adding URLs"
