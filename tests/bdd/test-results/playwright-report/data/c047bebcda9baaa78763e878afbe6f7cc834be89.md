...
- Name: Feature: Customizing the List URL >> Scenario: Change an existing custom URL
- Location: C:\projects\tests\bdd\cucumber-playwright-adapter.spec.jsx:101:11

# Error details

```
Error: Command failed: npx cross-env TEST_TYPE=bdd cucumber-js "C:\projects\tests\bdd\features\customize-list-url.feature" --require="C:\projects\tests\bdd\cucumber-setup.cjs" --require=C:\projects\tests\bdd\steps/**/*.{jsx,cjs} --require=C:\projects\tests\bdd\support/**/*.{jsx,cjs} --require=C:\projects\tests\bdd\pages/**/*.jsx --name "Change an existing custom URL"
